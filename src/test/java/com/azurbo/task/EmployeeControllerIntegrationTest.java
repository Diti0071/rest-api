...
public class EmployeeControllerIntegrationTest {
    ...
    public void testCreateEmployee() {
        ...
        employee.setEmail("azurbo@gmail.com");
        employee.setFirstName("Ardit");
        employee.setLastName("Zurbo");
    ...
    public void testUpdateEmployee() {
        ...
        employee.setFirstName("Ardit1");
        employee.setLastName("Ardit2");
